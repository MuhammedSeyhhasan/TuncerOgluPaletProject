    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainmenu">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a href="{{ route('home.urunlerimiz') }}" class="nav-link">ÜRÜNLERİMİZ</a></li>
                <li class="nav-item"><a href="{{ route('home.hakimizda') }}" class="nav-link">HAKKIMIZDA</a></li>
                <li class="nav-item"><a href="{{ route('home.iletisim') }}" class="nav-link">İLETİŞİM</a></li>
            </ul>
        </div>  
    </div>
</nav>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <p><a href="{{ route('home.index') }}" class="text-white"><i class="mdi mdi-chevron-right mr-1"></i>ANASAYFA</a></p>
                
                <p><a href="{{ route('home.urunlerimiz') }}" class="text-white"><i class="mdi mdi-chevron-right mr-1"></i>ÜRÜNLERİMİZ</a></p>
                
                <p><a href=" {{ route('home.hakimizda') }}" class="text-white"><i class="mdi mdi-chevron-right mr-1"></i>HAKKIMIZDA</a></p>
                
                <p><a href="{{ route('home.iletisim') }}" class="text-white"><i class="mdi mdi-chevron-right mr-1"></i>İLETİŞİM</a></p>
            ...
            <div class="col-lg-3 col-md-6 text-white">
                ...
                <p class="lead">tunceroglupalet@gmail.com </p>
