    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="<?php echo e(route('contact.send')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <div class="g-recaptcha" data-sitekey="6LffrPQnAAAAAAa98-6tNtOFXGRRTf0P78A1JynR" data-callback="6LffrPQnAAAAABCARTgvR8d36-9_ircuCpL4z30g"  required></div>
            </form>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Muhammed\Desktop\HAZIR PROJECTS\ForTuncer - Copy\resources\views/iletisim.blade.php ENDPATH**/ ?>